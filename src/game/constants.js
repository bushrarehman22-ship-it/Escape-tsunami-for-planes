...
export const REBIRTH_TIERS = [
  { rank: 0, title: 'Rookie Ground Crew', cost: 0, multiplier: 1.0, wings: null, bonusSpeed: 0, color: '#94a3b8' },
  { rank: 1, title: 'Propeller Pilot', cost: 15000, multiplier: 2.0, wings: 'bronze', bonusSpeed: 2, color: '#22c55e' },
  { rank: 2, title: 'Jet Aviator', cost: 85000, multiplier: 5.0, wings: 'silver', bonusSpeed: 4, color: '#3b82f6' },
  { rank: 3, title: 'Supersonic Ace', cost: 450000, multiplier: 12.0, wings: 'gold', bonusSpeed: 6, color: '#a855f7' },
  { rank: 4, title: 'Stealth Phantom', cost: 2500000, multiplier: 30.0, wings: 'plasma', bonusSpeed: 8, color: '#f97316' },
  { rank: 5, title: 'Orbital Commander', cost: 15000000, multiplier: 75.0, wings: 'ruby', bonusSpeed: 11, color: '#ec4899' },
  { rank: 6, title: 'Celestial Sky God', cost: 95000000, multiplier: 200.0, wings: 'cosmic', bonusSpeed: 15, color: '#06b6d4' },
  { rank: 7, title: 'Galactic Sovereign', cost: 650000000, multiplier: 600.0, wings: 'godly', bonusSpeed: 20, color: '#fbbf24' },
  { rank: 8, title: 'Nebula Voyager', cost: 4500000000, multiplier: 1800.0, wings: 'nebula', bonusSpeed: 25, color: '#818cf8' },
  { rank: 9, title: 'Pulsar Conqueror', cost: 30000000000, multiplier: 5500.0, wings: 'pulsar', bonusSpeed: 30, color: '#c084fc' },
  { rank: 10, title: 'Singularity Aviator', cost: 200000000000, multiplier: 16000.0, wings: 'singularity', bonusSpeed: 36, color: '#f43f5e' },
  { rank: 11, title: 'Hyperspace Overlord', cost: 1500000000000, multiplier: 50000.0, wings: 'hyperspace', bonusSpeed: 42, color: '#10b981' },
  { rank: 12, title: 'Chrono Flyer', cost: 10000000000000, multiplier: 150000.0, wings: 'chrono', bonusSpeed: 50, color: '#38bdf8' },
  { rank: 13, title: 'Dark Matter Pilot', cost: 75000000000000, multiplier: 450000.0, wings: 'darkmatter', bonusSpeed: 58, color: '#6366f1' },
  { rank: 14, title: 'Quantum Dominator', cost: 500000000000000, multiplier: 1400000.0, wings: 'quantum', bonusSpeed: 68, color: '#a855f7' },
  { rank: 15, title: 'Void Titan', cost: 3500000000000000, multiplier: 4500000.0, wings: 'void', bonusSpeed: 80, color: '#ec4899' },
  { rank: 16, title: 'Supernova Sovereign', cost: 25000000000000000, multiplier: 14000000.0, wings: 'supernova', bonusSpeed: 95, color: '#f97316' },
  { rank: 17, title: 'Interstellar Monarch', cost: 180000000000000000, multiplier: 45000000.0, wings: 'monarch', bonusSpeed: 110, color: '#eab308' },
  { rank: 18, title: 'Multiversal Commander', cost: 1200000000000000000, multiplier: 150000000.0, wings: 'multiverse', bonusSpeed: 130, color: '#06b6d4' },
  { rank: 19, title: 'Infinite Skies Entity', cost: 8000000000000000000, multiplier: 500000000.0, wings: 'infinite', bonusSpeed: 155, color: '#f43f5e' },
  { rank: 20, title: 'Omnipotent Sky Deity', cost: 50000000000000000000, multiplier: 2000000000.0, wings: 'god_omni', bonusSpeed: 200, color: '#fbbf24' }
];

export const SPEED_UPGRADES = {
  sprintVelocity: {
    id: 'sprintVelocity',
    name: 'Nitro Turbo Thrusters',
    icon: '⚡',
    baseCost: 200,
    costMultiplier: 1.35,
    maxLevel: 50,
    description: 'Increases raw movement running and sprint speed.',
    getValue: (lvl) => 14 + (lvl - 1) * 2.2,
    formatValue: (val) => `${val.toFixed(1)} m/s`
  },
  dashCooldown: {
    id: 'dashCooldown',
    name: 'Instant Dash Supercharger',
    icon: '🚀',
    baseCost: 800,
    costMultiplier: 1.6,
    maxLevel: 15,
    description: 'Drastically reduces Turbo Jet Dash cooldown for non-stop boosting.',
    getValue: (lvl) => Math.max(0.4, 4.5 - (lvl - 1) * 0.28),
    formatValue: (val) => `${val.toFixed(2)}s CD`
  },
  multiJump: {
    id: 'multiJump',
    name: 'Anti-Gravity Jump Jets',
    icon: '🦘',
    baseCost: 1500,
    costMultiplier: 2.2,
    maxLevel: 5,
    description: 'Enables double and triple jump to leap high above hazards.',
    getValue: (lvl) => Math.min(3, 1 + Math.floor((lvl - 1) / 2)), // 1, 1, 2, 2, 3 jumps
    formatValue: (val) => `${val}x Jump Power`
  },
  trailParticle: {
    id: 'trailParticle',
    name: 'Jet Trail FX Overdrive',
    icon: '✨',
    baseCost: 3000,
    costMultiplier: 2.5,
    maxLevel: 6,
    description: 'Unlocks glowing nitro jet trails (Cyan, Gold, Crimson, Plasma, Void).',
    getValue: (lvl) => lvl,
    formatValue: (val) => `FX Tier ${val}`
  }
};
